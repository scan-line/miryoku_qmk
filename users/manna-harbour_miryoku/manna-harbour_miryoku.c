...
const key_override_t rgb_tog_key_override = ko_make_with_layers(MOD_MASK_CTRL, RGB_TOG, AU_TOGG, LAYER_MASK_MEDIA);
const key_override_t rgb_vai_key_override = ko_make_with_layers(MOD_MASK_CTRL, RGB_VAI, RGB_SPI, LAYER_MASK_MEDIA);
